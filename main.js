...
class Main {
    ...
    initCanvas(e) {
        ...
        const contentImg = document.getElementById('canvas');
        contentImg.width = this.videoWidth;
        contentImg.height = this.videoHeight;
    }
    ...
    initializeStyleTransfer() {
        // Initialize images
        this.contentImg = document.getElementById('canvas');
        this.videoInput = document.getElementById('videoInput');
        this.ctx = this.contentImg.getContext('2d');
        ...
        this.uploadButton = document.getElementById('button-upload-video');
        this.uploadButton.onclick = this.uploadVideo;
        this.recordButton = document.getElementById('button-record-video');
        this.recordButton.onclick = this.initRecording;
